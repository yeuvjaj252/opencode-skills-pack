---
name: skill-csp-react-best-practices
...
| Need                    | Skill                             |
| ----------------------- | --------------------------------- |
| API design patterns     | `@[skills/skill-csp-api-patterns]`          |
| Database optimization   | `@[skills/skill-csp-database-design]`       |
| Testing strategies      | `@[skills/skill-csp-testing-patterns]`      |
| UI/UX design principles | `@[skills/skill-csp-frontend-design]`       |
| TypeScript patterns     | `@[skills/skill-csp-typescript-expert]`     |
| Deployment & DevOps     | `@[skills/skill-csp-deployment-procedures]` |
