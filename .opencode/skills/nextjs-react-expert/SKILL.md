...
| Need                    | Skill                             |
| ----------------------- | --------------------------------- |
| API design patterns     | `@[.opencode/skills/api-patterns]`          |
| Database optimization   | `@[.opencode/skills/database-design]`       |
| Testing strategies      | `@[.opencode/skills/testing-patterns]`      |
| UI/UX design principles | `@[.opencode/skills/frontend-design]`       |
| TypeScript patterns     | `@[.opencode/skills/typescript-expert]`     |
| Deployment & DevOps     | `@[.opencode/skills/deployment-procedures]` |
